...
function getPageName() {
    var subUrl = window.location.href.split("?")[0].split("//")[1];
    var pathStart = subUrl.indexOf('/')
    var pageName = subUrl.substring(pathStart).toLowerCase();
